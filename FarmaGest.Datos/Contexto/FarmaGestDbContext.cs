...
public class FarmaGestDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CoberturaPlan>(e =>
        {
            ...
            e.Property(x => x.PorcentajeCobertura)
                .HasColumnName("porcentajeCobertura")
        ...
        modelBuilder.Entity<Receta>(e =>
        {
            ...
            e.HasOne(x => x.Afiliado)
                .WithMany(a => a.Recetas)
        ...
        modelBuilder.Entity<Caja>(e =>
        {
            ...
            e.Property(x => x.MontoInicial)
                .HasColumnName("monto_inicial")
                .HasColumnType("decimal(10,2)");

            e.Property(x => x.MontoFinal)
        ...
        modelBuilder.Entity<Facturacion>(e =>
        {
            ...
            e.Property(x => x.MetodoPago)
                .HasColumnName("metodo_pago")
                .HasMaxLength(30)
                .IsRequired();

            e.Property(x => x.Importe)
                .HasColumnName("importe")
                .HasColumnType("decimal(10,2)");

            e.Property(x => x.VentaId)
                .HasColumnName("id_venta");

            e.Property(x => x.UsuarioId)
                .HasColumnName("id_usuario");

            e.Property(x => x.CajaId)
                .HasColumnName("id_caja");

            // Una venta solamente puede facturarse una vez
